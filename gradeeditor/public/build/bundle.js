...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	let strong0;
    	let t5;
    	let t6_value = /*getCurrentGrade*/ ctx[2]() + "";
    	let t6;
    	let t7;
    	let p1;
    	let strong1;
    	...
    	const block = {
    		c: function create() {
    			...
    			summary.textContent = "Category 1";
    			t17 = space();
    			ul4 = element("ul");
    			li4 = element("li");
    			nav1 = element("nav");
    			ul2 = element("ul");
    			li2 = element("li");
    			li2.textContent = "Assignment Name";
    			t19 = space();
    			ul3 = element("ul");
    			li3 = element("li");
    			div1 = element("div");
    			...
    			add_location(nav0, file$1, 35, 0, 1014);
    			...
    			add_location(div0, file$1, 44, 0, 1230);
    			add_location(hr, file$1, 50, 0, 1400);
    			add_location(summary, file$1, 52, 4, 1426);
    			add_location(li2, file$1, 56, 20, 1520);
    			add_location(ul2, file$1, 56, 16, 1516);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 59, 24, 1641);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out of");
    			add_location(input1, file$1, 60, 24, 1708);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 58, 20, 1597);
    			add_location(li3, file$1, 57, 20, 1571);
    			add_location(ul3, file$1, 57, 16, 1567);
    			add_location(nav1, file$1, 55, 12, 1493);
    			add_location(li4, file$1, 54, 8, 1475);
    			add_location(ul4, file$1, 53, 4, 1461);
    			details.open = true;
    			add_location(details, file$1, 51, 0, 1406);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*categories*/ 16) {
    			console.log(categories);
    		}
    	};

    	return [course, dispatch, getCurrentGrade, newGrade, categories, click_handler];
    }
