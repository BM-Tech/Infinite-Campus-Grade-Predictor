...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 134, 12, 4367);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 133, 8, 4311);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(133:4) {#if showAreas.newAssig}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 140, 12, 4517);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 139, 8, 4461);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, p);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(139:4) {#if showAreas.addFinal}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 146, 12, 4663);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 145, 8, 4607);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, p);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(145:4) {#if showAreas.showGraph}",
    		ctx
    	});
    ...
    // (178:12) {#each cat.assignments as assig}
    function create_each_block_1(ctx) {
    	let li2;
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*assig*/ ctx[16].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input0_input_handler() {
    		/*input0_input_handler*/ ctx[11].call(input0, /*each_value_1*/ ctx[17], /*assig_index*/ ctx[18]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[12].call(input1, /*each_value_1*/ ctx[17], /*assig_index*/ ctx[18]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			add_location(li0, file$1, 179, 24, 5757);
    			add_location(ul0, file$1, 179, 20, 5753);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 182, 28, 5887);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out Of");
    			add_location(input1, file$1, 183, 28, 5983);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 181, 24, 5839);
    			add_location(li1, file$1, 180, 24, 5809);
    			add_location(ul1, file$1, 180, 20, 5805);
    			add_location(nav, file$1, 178, 20, 5726);
    			add_location(li2, file$1, 178, 16, 5722);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*assig*/ ctx[16].score);
    			append_dev(div, t2);
    			append_dev(div, input1);
    			set_input_value(input1, /*assig*/ ctx[16].outof);
    			append_dev(nav, t3);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*categories*/ 4 && t0_value !== (t0_value = /*assig*/ ctx[16].name + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*categories*/ 4 && to_number(input0.value) !== /*assig*/ ctx[16].score) {
    				set_input_value(input0, /*assig*/ ctx[16].score);
    			}

    			if (dirty & /*categories*/ 4 && to_number(input1.value) !== /*assig*/ ctx[16].outof) {
    				set_input_value(input1, /*assig*/ ctx[16].outof);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(178:12) {#each cat.assignments as assig}",
    		ctx
    	});
    ...
    // (174:0) {#each categories as cat}
    function create_each_block(ctx) {
    	let details;
    	let summary;
    	let t0_value = /*cat*/ ctx[13].toString() + "";
    	let t0;
    	let t1;
    	let ul;
    	let t2;
    	let each_value_1 = /*cat*/ ctx[13].assignments;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			add_location(summary, file$1, 175, 8, 5592);
    			attr_dev(ul, "class", "longlist");
    			add_location(ul, file$1, 176, 8, 5637);
    			add_location(details, file$1, 174, 4, 5573);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*categories*/ 4 && t0_value !== (t0_value = /*cat*/ ctx[13].toString() + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*categories*/ 4) {
    				each_value_1 = /*cat*/ ctx[13].assignments;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(174:0) {#each categories as cat}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h3, file$1, 113, 12, 3665);
    			add_location(li0, file$1, 113, 8, 3661);
    			add_location(ul0, file$1, 112, 4, 3647);
    			attr_dev(a, "href", "#/");
    			add_location(a, file$1, 116, 12, 3749);
    			add_location(li1, file$1, 116, 8, 3745);
    			add_location(ul1, file$1, 115, 4, 3731);
    			add_location(nav, file$1, 111, 0, 3636);
    			add_location(strong0, file$1, 121, 7, 3879);
    			add_location(p0, file$1, 121, 4, 3876);
    			add_location(strong1, file$1, 122, 7, 3940);
    			add_location(p1, file$1, 122, 4, 3937);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 120, 0, 3852);
    			add_location(button0, file$1, 126, 4, 4031);
    			add_location(button1, file$1, 127, 4, 4110);
    			add_location(button2, file$1, 128, 4, 4184);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 125, 0, 4007);
    			add_location(div2, file$1, 131, 0, 4266);
    			add_location(hr, file$1, 151, 0, 4723);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Editor extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*course*/ ctx[0] === undefined && !('course' in props)) {
    			console.warn("<Editor> was created without expected prop 'course'");
    		}
    	}
