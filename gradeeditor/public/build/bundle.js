...
var app = (function () {
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "#a");
    			add_location(a0, file$1, 295, 8, 9627);
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 296, 8, 9715);
    			attr_dev(a2, "href", "#a");
    			add_location(a2, file$1, 297, 8, 9803);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(a0, "click", /*click_handler_4*/ ctx[26], false, false, false),
    					listen_dev(a1, "click", /*click_handler_5*/ ctx[27], false, false, false),
    					listen_dev(a2, "click", /*click_handler_6*/ ctx[28], false, false, false)
    				];
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(h4, file$1, 305, 12, 10044);
    			add_location(p, file$1, 306, 12, 10082);
    			add_location(hr, file$1, 321, 12, 10725);
    			add_location(br, file$1, 321, 16, 10729);
    			add_location(li0, file$1, 323, 20, 10794);
    			add_location(ul0, file$1, 323, 16, 10790);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "category");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 326, 24, 10932);
    			attr_dev(label, "for", "category");
    			add_location(label, file$1, 325, 20, 10884);
    			add_location(li1, file$1, 324, 20, 10858);
    			add_location(ul1, file$1, 324, 16, 10854);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 322, 12, 10747);
    			add_location(div, file$1, 304, 8, 10025);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 303, 4, 9973);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_5(ctx) {
    	...
    	function input_change_handler() {
    		/*input_change_handler*/ ctx[29].call(input, /*cat*/ ctx[47]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(li0, file$1, 310, 24, 10295);
    			add_location(ul0, file$1, 309, 20, 10265);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 314, 28, 10447);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 313, 28, 10397);
    			add_location(li1, file$1, 313, 24, 10393);
    			add_location(ul1, file$1, 312, 20, 10363);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 308, 16, 10219);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[47].name];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*cat*/ ctx[47].name + "")) set_data_dev(t0, t0_value);
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$1, 338, 12, 11295);
    			add_location(p, file$1, 339, 12, 11333);
    			add_location(div, file$1, 337, 8, 11276);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 336, 4, 11224);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, div);
    ...
    function create_each_block_4(ctx) {
    	...
    	let ul0;
    	let li0;
    	let t0_value = /*terms*/ ctx[6][/*term*/ ctx[57]].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input_change_handler_2() {
    		/*input_change_handler_2*/ ctx[31].call(input, /*term*/ ctx[57]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			t2 = space();
    			add_location(li0, file$1, 343, 24, 11568);
    			add_location(ul0, file$1, 342, 20, 11538);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 347, 28, 11728);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 346, 28, 11678);
    			add_location(li1, file$1, 346, 24, 11674);
    			add_location(ul1, file$1, 345, 20, 11644);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 341, 16, 11492);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, nav, anchor);
    			append_dev(nav, ul0);
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].termEnabled[/*term*/ ctx[57].toString()];
    			append_dev(nav, t2);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*terms*/ 64 && t0_value !== (t0_value = /*terms*/ ctx[6][/*term*/ ctx[57]].name + "")) set_data_dev(t0, t0_value);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 363, 20, 12316);
    			attr_dev(label0, "for", "aName");
    			add_location(label0, file$1, 362, 16, 12260);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*newAssig*/ ctx[8]["catName"] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[33].call(select));
    			add_location(select, file$1, 367, 20, 12469);
    			attr_dev(label1, "for", "aCat");
    			add_location(label1, file$1, 366, 16, 12421);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 361, 12, 12224);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aScore");
    			input1.required = true;
    			add_location(input1, file$1, 377, 20, 12865);
    			attr_dev(label2, "for", "aScore");
    			add_location(label2, file$1, 376, 16, 12818);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "name", "aOutOf");
    			input2.required = true;
    			add_location(input2, file$1, 380, 20, 13029);
    			attr_dev(label3, "for", "aOutOf");
    			add_location(label3, file$1, 379, 16, 12981);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 375, 12, 12782);
    			attr_dev(input3, "type", "submit");
    			input3.value = "Add";
    			add_location(input3, file$1, 384, 12, 13163);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 360, 8, 12149);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 359, 4, 12097);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*cat*/ ctx[47].name;
    			option.value = option.__value;
    			add_location(option, file$1, 369, 28, 12612);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories*/ 8 && t_value !== (t_value = /*cat*/ ctx[47].name + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*categories*/ 8 && option_value_value !== (option_value_value = /*cat*/ ctx[47].name)) {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 395, 20, 13516);
    			attr_dev(label0, "for", "cName");
    			add_location(label0, file$1, 394, 16, 13462);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "100");
    			attr_dev(input1, "name", "cWeight");
    			input1.required = true;
    			add_location(input1, file$1, 398, 20, 13684);
    			attr_dev(label1, "for", "cWeight");
    			add_location(label1, file$1, 397, 16, 13631);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 393, 12, 13426);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add";
    			add_location(input2, file$1, 401, 12, 13839);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 392, 8, 13353);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 391, 4, 13301);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, form);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 408, 4, 13963);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t22 = text("%.");
    			add_location(h4, file$1, 416, 8, 14219);
    			add_location(p0, file$1, 417, 8, 14273);
    			add_location(p1, file$1, 419, 12, 14442);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "%");
    			add_location(input0, file$1, 420, 12, 14486);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 418, 8, 14410);
    			add_location(p2, file$1, 422, 8, 14574);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*minNeedAssig*/ ctx[5]["catName"] === void 0) add_render_callback(() => /*select_change_handler_1*/ ctx[39].call(select));
    			add_location(select, file$1, 425, 16, 14687);
    			attr_dev(label0, "for", "aCat");
    			add_location(label0, file$1, 424, 12, 14643);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aOutOf");
    			input1.required = true;
    			add_location(input1, file$1, 433, 16, 15008);
    			attr_dev(label1, "for", "aOutOf");
    			add_location(label1, file$1, 432, 12, 14964);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 423, 8, 14611);
    			add_location(strong, file$1, 437, 33, 15159);
    			add_location(p3, file$1, 437, 8, 15134);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 415, 4, 14167);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*input0_input_handler_2*/ ctx[38]),
    					listen_dev(select, "change", /*select_change_handler_1*/ ctx[39]),
    					listen_dev(input1, "input", /*input1_input_handler_2*/ ctx[40])
    				];
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = option_value_value = /*cat*/ ctx[47].name;
    			option.value = option.__value;
    			add_location(option, file$1, 427, 24, 14826);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    ...
    function create_if_block$1(ctx) {
    	...
    	let ul0;
    	let li0;
    	let t0_value = /*assig*/ ctx[50].name + "";
    	let t0;
    	let t1;
    	let t2_value = /*assig*/ ctx[50].toString() + "";
    	let t2;
    	let t3;
    	let t4_value = /*assig*/ ctx[50].getOgGrade() + "";
    	let t4;
    	let t5;
    	let small;
    	let a;
    	...
    	function input0_input_handler_3() {
    		/*input0_input_handler_3*/ ctx[42].call(input0, /*each_value_1*/ ctx[51], /*assig_index*/ ctx[52]);
    	}

    	function input1_input_handler_3() {
    		/*input1_input_handler_3*/ ctx[43].call(input1, /*each_value_1*/ ctx[51], /*assig_index*/ ctx[52]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			attr_dev(a, "href", "#a");
    			add_location(a, file$1, 466, 32, 16343);
    			attr_dev(small, "class", "modifiers");
    			add_location(small, file$1, 465, 28, 16284);
    			add_location(li0, file$1, 462, 28, 16130);
    			add_location(ul0, file$1, 462, 24, 16126);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 474, 32, 16856);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out Of");
    			add_location(input1, file$1, 475, 32, 16956);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 473, 28, 16804);
    			add_location(li1, file$1, 472, 28, 16770);
    			add_location(ul1, file$1, 472, 24, 16766);
    			add_location(nav, file$1, 461, 24, 16095);
    			add_location(li2, file$1, 461, 20, 16091);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*assig*/ ctx[50].score);
    			append_dev(div, t9);
    			append_dev(div, input1);
    			set_input_value(input1, /*assig*/ ctx[50].outof);
    			append_dev(nav, t10);
    				...
    				dispose = [
    					listen_dev(
    						...
    						prevent_default(function () {
    							if (is_function(/*deleteAssignment*/ ctx[16](/*cat*/ ctx[47], /*assig*/ ctx[50]))) /*deleteAssignment*/ ctx[16](/*cat*/ ctx[47], /*assig*/ ctx[50]).apply(this, arguments);
    						}),
    						false,
    						true,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*assig*/ ctx[50].name + "")) set_data_dev(t0, t0_value);
    			if (dirty[0] & /*categories*/ 8 && t2_value !== (t2_value = /*assig*/ ctx[50].toString() + "")) set_data_dev(t2, t2_value);
    			if (dirty[0] & /*categories*/ 8 && t4_value !== (t4_value = /*assig*/ ctx[50].getOgGrade() + "")) set_data_dev(t4, t4_value);
    			...
    			if (dirty[0] & /*categories*/ 8 && to_number(input0.value) !== /*assig*/ ctx[50].score) {
    				set_input_value(input0, /*assig*/ ctx[50].score);
    			}

    			if (dirty[0] & /*categories*/ 8 && to_number(input1.value) !== /*assig*/ ctx[50].outof) {
    				set_input_value(input1, /*assig*/ ctx[50].outof);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "#a");
    			add_location(a, file$1, 468, 36, 16530);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					prevent_default(function () {
    						if (is_function(/*makeAssigVariable*/ ctx[20](/*assig*/ ctx[50].outof, /*cat*/ ctx[47].name))) /*makeAssigVariable*/ ctx[20](/*assig*/ ctx[50].outof, /*cat*/ ctx[47].name).apply(this, arguments);
    					}),
    					false,
    					true,
    					false
    ...
    function create_each_block_1(ctx) {
    	let show_if = /*assig*/ ctx[50].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    	let if_block_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories, courseSettings*/ 10) show_if = /*assig*/ ctx[50].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    ...
    function create_each_block(ctx) {
    	let details;
    	let summary;
    	let t0_value = /*cat*/ ctx[47].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[47].name], /*courseSettings*/ ctx[1].termEnabled) + "";
    	let t0;
    	let t1;
    	let ul2;
    	let nav;
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[41].call(input, /*each_value*/ ctx[48], /*cat_index*/ ctx[49]);
    	}

    	let each_value_1 = /*cat*/ ctx[47].assignments;
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			add_location(summary, file$1, 446, 8, 15441);
    			add_location(li0, file$1, 449, 20, 15615);
    			add_location(ul0, file$1, 449, 16, 15611);
    			attr_dev(input, "type", "number");
    			add_location(input, file$1, 452, 24, 15729);
    			add_location(p, file$1, 453, 24, 15801);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 451, 20, 15685);
    			add_location(li1, file$1, 450, 20, 15659);
    			add_location(ul1, file$1, 450, 16, 15655);
    			add_location(nav, file$1, 448, 12, 15588);
    			add_location(br, file$1, 457, 12, 15899);
    			attr_dev(ul2, "class", "longlist");
    			add_location(ul2, file$1, 447, 8, 15553);
    			add_location(details, file$1, 445, 4, 15422);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*cat*/ ctx[47].weight);
    			append_dev(div, t4);
    			append_dev(div, p);
    			append_dev(ul2, t6);
    			append_dev(ul2, br);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories, courseSettings*/ 10 && t0_value !== (t0_value = /*cat*/ ctx[47].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[47].name], /*courseSettings*/ ctx[1].termEnabled) + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*categories*/ 8 && to_number(input.value) !== /*cat*/ ctx[47].weight) {
    				set_input_value(input, /*cat*/ ctx[47].weight);
    			}

    			if (dirty[0] & /*categories, makeAssigVariable, showAreas, deleteAssignment, courseSettings*/ 1114250) {
    				each_value_1 = /*cat*/ ctx[47].assignments;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 293, 4, 9517);
    			attr_dev(small, "class", "sidewayslist");
    			add_location(small, file$1, 292, 0, 9483);
    			add_location(br0, file$1, 441, 0, 15335);
    			add_location(br1, file$1, 441, 4, 15339);
    			add_location(hr, file$1, 443, 0, 15385);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(a1, "click", /*click_handler_3*/ ctx[25], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (/*showAreas*/ ctx[7].whatToMaintain) {
    				if (if_block7) {
    					...
    					if_block7.c();
    					transition_in(if_block7, 1);
    					if_block7.m(t26.parentNode, t26);
    				}
    			} else if (if_block7) {
    				group_outros();
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('key' in $$props) $$invalidate(44, key = $$props.key);
