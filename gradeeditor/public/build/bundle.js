...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	let button;
    	let strong;
    	let t0_value = /*cl*/ ctx[5].details[0].task.courseName + "";
    	let t0;
    	let t1;
    	let t2_value = getGradeFromClass(/*cl*/ ctx[5].details) + "";
    	let t2;
    	let t3;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(strong, file$3, 59, 8, 1830);
    			set_style(button, "padding", "5", 1);
    			add_location(button, file$3, 58, 4, 1751);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*classes*/ 1 && t0_value !== (t0_value = /*cl*/ ctx[5].details[0].task.courseName + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*classes*/ 1 && t2_value !== (t2_value = getGradeFromClass(/*cl*/ ctx[5].details) + "")) set_data_dev(t2, t2_value);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(br, file$3, 56, 0, 1715);
    		},
    ...
    function create_if_block_9(ctx) {
    	...
    	let strong0;
    	let t1;
    	let t2_value = /*getCurrentGrade*/ ctx[14]() + "";
    	let t2;
    	let t3;
    	let strong1;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = text(t6_value);
    			t7 = text("%");
    			add_location(strong0, file$1, 282, 11, 9053);
    			add_location(strong1, file$1, 282, 61, 9103);
    			add_location(p, file$1, 282, 8, 9050);
    			attr_dev(div, "class", "sticky");
    			add_location(div, file$1, 281, 4, 9020);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			a2 = element("a");
    			a2.textContent = "Minimum Need";
    			attr_dev(a0, "href", "#a");
    			add_location(a0, file$1, 295, 8, 9618);
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 296, 8, 9706);
    			attr_dev(a2, "href", "#a");
    			add_location(a2, file$1, 297, 8, 9794);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(a0, "click", /*click_handler_5*/ ctx[27], false, false, false),
    					listen_dev(a1, "click", /*click_handler_6*/ ctx[28], false, false, false),
    					listen_dev(a2, "click", /*click_handler_7*/ ctx[29], false, false, false)
    				];
    ...
    // (303:0) {#if showAreas.equalWeighting}
    function create_if_block_7(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_5 = /*categories*/ ctx[3];
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(h4, file$1, 305, 12, 10035);
    			add_location(p, file$1, 306, 12, 10073);
    			add_location(hr, file$1, 321, 12, 10716);
    			add_location(br, file$1, 321, 16, 10720);
    			add_location(li0, file$1, 323, 20, 10785);
    			add_location(ul0, file$1, 323, 16, 10781);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "category");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 326, 24, 10923);
    			attr_dev(label, "for", "category");
    			add_location(label, file$1, 325, 20, 10875);
    			add_location(li1, file$1, 324, 20, 10849);
    			add_location(ul1, file$1, 324, 16, 10845);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 322, 12, 10738);
    			add_location(div, file$1, 304, 8, 10016);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 303, 4, 9964);
    		},
    		m: function mount(target, anchor) {
    			...
    			input.checked = /*courseSettings*/ ctx[1].allCategoriesWeightedSame;
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(input, "change", /*input_change_handler_1*/ ctx[31]);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*courseSettings, categories*/ 10) {
    				each_value_5 = /*categories*/ ctx[3];
    				validate_each_argument(each_value_5);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(303:0) {#if showAreas.equalWeighting}",
    		ctx
    	});
    ...
    // (308:12) {#each categories as cat}
    function create_each_block_5(ctx) {
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*cat*/ ctx[48].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input_change_handler() {
    		/*input_change_handler*/ ctx[30].call(input, /*cat*/ ctx[48]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(li0, file$1, 310, 24, 10286);
    			add_location(ul0, file$1, 309, 20, 10256);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 314, 28, 10438);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 313, 28, 10388);
    			add_location(li1, file$1, 313, 24, 10384);
    			add_location(ul1, file$1, 312, 20, 10354);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 308, 16, 10210);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[48].name];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*cat*/ ctx[48].name + "")) set_data_dev(t0, t0_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(308:12) {#each categories as cat}",
    		ctx
    	});
    ...
    // (336:0) {#if showAreas.gradingPeriods}
    function create_if_block_6(ctx) {
    	...
    	let article_transition;
    	let current;
    	let each_value_4 = Object.keys(/*terms*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$1, 338, 12, 11286);
    			add_location(p, file$1, 339, 12, 11324);
    			add_location(div, file$1, 337, 8, 11267);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 336, 4, 11215);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, div);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*courseSettings, terms*/ 66) {
    				each_value_4 = Object.keys(/*terms*/ ctx[6]);
    				validate_each_argument(each_value_4);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(336:0) {#if showAreas.gradingPeriods}",
    		ctx
    	});
    ...
    // (341:12) {#each Object.keys(terms) as term}
    function create_each_block_4(ctx) {
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*terms*/ ctx[6][/*term*/ ctx[58]].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input_change_handler_2() {
    		/*input_change_handler_2*/ ctx[32].call(input, /*term*/ ctx[58]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			t2 = space();
    			add_location(li0, file$1, 343, 24, 11559);
    			add_location(ul0, file$1, 342, 20, 11529);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 347, 28, 11719);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 346, 28, 11669);
    			add_location(li1, file$1, 346, 24, 11665);
    			add_location(ul1, file$1, 345, 20, 11635);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 341, 16, 11483);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, nav, anchor);
    			append_dev(nav, ul0);
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].termEnabled[/*term*/ ctx[58].toString()];
    			append_dev(nav, t2);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*terms*/ 64 && t0_value !== (t0_value = /*terms*/ ctx[6][/*term*/ ctx[58]].name + "")) set_data_dev(t0, t0_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(341:12) {#each Object.keys(terms) as term}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_3 = /*categories*/ ctx[3];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 363, 20, 12307);
    			attr_dev(label0, "for", "aName");
    			add_location(label0, file$1, 362, 16, 12251);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*newAssig*/ ctx[8]["catName"] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[34].call(select));
    			add_location(select, file$1, 367, 20, 12460);
    			attr_dev(label1, "for", "aCat");
    			add_location(label1, file$1, 366, 16, 12412);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 361, 12, 12215);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aScore");
    			input1.required = true;
    			add_location(input1, file$1, 377, 20, 12856);
    			attr_dev(label2, "for", "aScore");
    			add_location(label2, file$1, 376, 16, 12809);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "name", "aOutOf");
    			input2.required = true;
    			add_location(input2, file$1, 380, 20, 13020);
    			attr_dev(label3, "for", "aOutOf");
    			add_location(label3, file$1, 379, 16, 12972);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 375, 12, 12773);
    			attr_dev(input3, "type", "submit");
    			input3.value = "Add";
    			add_location(input3, file$1, 384, 12, 13154);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 360, 8, 12140);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 359, 4, 12088);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			...
    			set_input_value(input0, /*newAssig*/ ctx[8].name);
    			append_dev(div0, t1);
    			...
    			select_option(select, /*newAssig*/ ctx[8]["catName"]);
    			append_dev(form, t3);
    			append_dev(form, div1);
    			append_dev(div1, label2);
    			append_dev(label2, t4);
    			append_dev(label2, input1);
    			set_input_value(input1, /*newAssig*/ ctx[8].score);
    			append_dev(div1, t5);
    			append_dev(div1, label3);
    			append_dev(label3, t6);
    			append_dev(label3, input2);
    			set_input_value(input2, /*newAssig*/ ctx[8].outof);
    			append_dev(form, t7);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*submitAssignment*/ ctx[17]), false, true, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*newAssig, categories*/ 264 && input0.value !== /*newAssig*/ ctx[8].name) {
    				set_input_value(input0, /*newAssig*/ ctx[8].name);
    			}

    			if (dirty[0] & /*categories*/ 8) {
    				each_value_3 = /*categories*/ ctx[3];
    				validate_each_argument(each_value_3);
    				let i;
    			...
    			if (dirty[0] & /*newAssig, categories*/ 264) {
    				select_option(select, /*newAssig*/ ctx[8]["catName"]);
    			}

    			if (dirty[0] & /*newAssig, categories*/ 264 && to_number(input1.value) !== /*newAssig*/ ctx[8].score) {
    				set_input_value(input1, /*newAssig*/ ctx[8].score);
    			}

    			if (dirty[0] & /*newAssig, categories*/ 264 && to_number(input2.value) !== /*newAssig*/ ctx[8].outof) {
    				set_input_value(input2, /*newAssig*/ ctx[8].outof);
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(359:0) {#if showAreas.newAssig}",
    		ctx
    	});
    ...
    // (369:24) {#each categories as cat}
    function create_each_block_3(ctx) {
    	let option;
    	let t_value = /*cat*/ ctx[48].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*cat*/ ctx[48].name;
    			option.value = option.__value;
    			add_location(option, file$1, 369, 28, 12603);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories*/ 8 && t_value !== (t_value = /*cat*/ ctx[48].name + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*categories*/ 8 && option_value_value !== (option_value_value = /*cat*/ ctx[48].name)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(369:24) {#each categories as cat}",
    		ctx
    	});
    ...
    // (391:0) {#if showAreas.newCategory}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 395, 20, 13507);
    			attr_dev(label0, "for", "cName");
    			add_location(label0, file$1, 394, 16, 13453);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "100");
    			attr_dev(input1, "name", "cWeight");
    			input1.required = true;
    			add_location(input1, file$1, 398, 20, 13675);
    			attr_dev(label1, "for", "cWeight");
    			add_location(label1, file$1, 397, 16, 13622);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 393, 12, 13417);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add";
    			add_location(input2, file$1, 401, 12, 13830);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 392, 8, 13344);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 391, 4, 13292);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, form);
    			...
    			append_dev(label0, t0);
    			append_dev(label0, input0);
    			set_input_value(input0, /*newCategory*/ ctx[9].name);
    			append_dev(div, t1);
    			append_dev(div, label1);
    			append_dev(label1, t2);
    			append_dev(label1, input1);
    			set_input_value(input1, /*newCategory*/ ctx[9].weight);
    			append_dev(form, t3);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*submitCategory*/ ctx[18]), false, true, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*newCategory*/ 512 && input0.value !== /*newCategory*/ ctx[9].name) {
    				set_input_value(input0, /*newCategory*/ ctx[9].name);
    			}

    			if (dirty[0] & /*newCategory*/ 512 && to_number(input1.value) !== /*newCategory*/ ctx[9].weight) {
    				set_input_value(input1, /*newCategory*/ ctx[9].weight);
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(391:0) {#if showAreas.newCategory}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 408, 4, 13954);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(408:0) {#if showAreas.showGraph}",
    		ctx
    	});
    ...
    // (415:0) {#if showAreas.whatToMaintain}
    function create_if_block_2$1(ctx) {
    	...
    	let t13;
    	let strong;
    	let t14_value = /*minNeedAssig*/ ctx[5].score + "";
    	let t14;
    	let t15;
    	let t16_value = /*minNeedAssig*/ ctx[5].outof + "";
    	let t16;
    	let t17;
    	let t18_value = /*minNeedAssig*/ ctx[5].toString() + "";
    	let t18;
    	let t19;
    	let t20;
    	let t21;
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = text(/*gradeWanted*/ ctx[4]);
    			t22 = text("%.");
    			add_location(h4, file$1, 416, 8, 14210);
    			add_location(p0, file$1, 417, 8, 14264);
    			add_location(p1, file$1, 419, 12, 14433);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "%");
    			add_location(input0, file$1, 420, 12, 14477);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 418, 8, 14401);
    			add_location(p2, file$1, 422, 8, 14565);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*minNeedAssig*/ ctx[5]["catName"] === void 0) add_render_callback(() => /*select_change_handler_1*/ ctx[40].call(select));
    			add_location(select, file$1, 425, 16, 14678);
    			attr_dev(label0, "for", "aCat");
    			add_location(label0, file$1, 424, 12, 14634);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aOutOf");
    			input1.required = true;
    			add_location(input1, file$1, 433, 16, 14999);
    			attr_dev(label1, "for", "aOutOf");
    			add_location(label1, file$1, 432, 12, 14955);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 423, 8, 14602);
    			add_location(strong, file$1, 437, 33, 15150);
    			add_location(p3, file$1, 437, 8, 15125);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 415, 4, 14158);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			...
    			set_input_value(input0, /*gradeWanted*/ ctx[4]);
    			...
    			select_option(select, /*minNeedAssig*/ ctx[5]["catName"]);
    			append_dev(div1, t10);
    			append_dev(div1, label1);
    			append_dev(label1, t11);
    			append_dev(label1, input1);
    			set_input_value(input1, /*minNeedAssig*/ ctx[5].outof);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*input0_input_handler_2*/ ctx[39]),
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*gradeWanted*/ 16 && to_number(input0.value) !== /*gradeWanted*/ ctx[4]) {
    				set_input_value(input0, /*gradeWanted*/ ctx[4]);
    			}
    			...
    			if (dirty[0] & /*minNeedAssig, categories*/ 40) {
    				select_option(select, /*minNeedAssig*/ ctx[5]["catName"]);
    			}

    			if (dirty[0] & /*minNeedAssig, categories*/ 40 && to_number(input1.value) !== /*minNeedAssig*/ ctx[5].outof) {
    				set_input_value(input1, /*minNeedAssig*/ ctx[5].outof);
    			}

    			if ((!current || dirty[0] & /*minNeedAssig*/ 32) && t14_value !== (t14_value = /*minNeedAssig*/ ctx[5].score + "")) set_data_dev(t14, t14_value);
    			if ((!current || dirty[0] & /*minNeedAssig*/ 32) && t16_value !== (t16_value = /*minNeedAssig*/ ctx[5].outof + "")) set_data_dev(t16, t16_value);
    			if ((!current || dirty[0] & /*minNeedAssig*/ 32) && t18_value !== (t18_value = /*minNeedAssig*/ ctx[5].toString() + "")) set_data_dev(t18, t18_value);
    			if (!current || dirty[0] & /*gradeWanted*/ 16) set_data_dev(t21, /*gradeWanted*/ ctx[4]);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(415:0) {#if showAreas.whatToMaintain}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = option_value_value = /*cat*/ ctx[48].name;
    			option.value = option.__value;
    			add_location(option, file$1, 427, 24, 14817);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(427:20) {#each categories as cat}",
    		ctx
    	});
    ...
    // (461:16) {#if assig.isEnabled(courseSettings.termEnabled)}
    function create_if_block$1(ctx) {
    	let li2;
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*assig*/ ctx[51].name + "";
    	let t0;
    	let t1;
    	let t2_value = /*assig*/ ctx[51].toString() + "";
    	let t2;
    	let t3;
    	let t4_value = /*assig*/ ctx[51].getOgGrade() + "";
    	let t4;
    	let t5;
    	let small;
    	let a;
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*showAreas*/ ctx[7].whatToMaintain && create_if_block_1$1(ctx);

    	function input0_input_handler_3() {
    		/*input0_input_handler_3*/ ctx[43].call(input0, /*each_value_1*/ ctx[52], /*assig_index*/ ctx[53]);
    	}

    	function input1_input_handler_3() {
    		/*input1_input_handler_3*/ ctx[44].call(input1, /*each_value_1*/ ctx[52], /*assig_index*/ ctx[53]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			attr_dev(a, "href", "#a");
    			add_location(a, file$1, 466, 32, 16334);
    			attr_dev(small, "class", "modifiers");
    			add_location(small, file$1, 465, 28, 16275);
    			add_location(li0, file$1, 462, 28, 16121);
    			add_location(ul0, file$1, 462, 24, 16117);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 474, 32, 16847);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out Of");
    			add_location(input1, file$1, 475, 32, 16947);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 473, 28, 16795);
    			add_location(li1, file$1, 472, 28, 16761);
    			add_location(ul1, file$1, 472, 24, 16757);
    			add_location(nav, file$1, 461, 24, 16086);
    			add_location(li2, file$1, 461, 20, 16082);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*assig*/ ctx[51].score);
    			append_dev(div, t9);
    			append_dev(div, input1);
    			set_input_value(input1, /*assig*/ ctx[51].outof);
    			append_dev(nav, t10);
    				...
    				dispose = [
    					listen_dev(
    						...
    						prevent_default(function () {
    							if (is_function(/*deleteAssignment*/ ctx[16](/*cat*/ ctx[48], /*assig*/ ctx[51]))) /*deleteAssignment*/ ctx[16](/*cat*/ ctx[48], /*assig*/ ctx[51]).apply(this, arguments);
    						}),
    						false,
    						true,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*assig*/ ctx[51].name + "")) set_data_dev(t0, t0_value);
    			if (dirty[0] & /*categories*/ 8 && t2_value !== (t2_value = /*assig*/ ctx[51].toString() + "")) set_data_dev(t2, t2_value);
    			if (dirty[0] & /*categories*/ 8 && t4_value !== (t4_value = /*assig*/ ctx[51].getOgGrade() + "")) set_data_dev(t4, t4_value);

    			if (/*showAreas*/ ctx[7].whatToMaintain) {
    				if (if_block) {
    			...
    			if (dirty[0] & /*categories*/ 8 && to_number(input0.value) !== /*assig*/ ctx[51].score) {
    				set_input_value(input0, /*assig*/ ctx[51].score);
    			}

    			if (dirty[0] & /*categories*/ 8 && to_number(input1.value) !== /*assig*/ ctx[51].outof) {
    				set_input_value(input1, /*assig*/ ctx[51].outof);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(461:16) {#if assig.isEnabled(courseSettings.termEnabled)}",
    		ctx
    	});
    ...
    // (468:32) {#if showAreas.whatToMaintain}
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "#a");
    			add_location(a, file$1, 468, 36, 16521);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					prevent_default(function () {
    						if (is_function(/*makeAssigVariable*/ ctx[20](/*assig*/ ctx[51].outof, /*cat*/ ctx[48].name))) /*makeAssigVariable*/ ctx[20](/*assig*/ ctx[51].outof, /*cat*/ ctx[48].name).apply(this, arguments);
    					}),
    					false,
    					true,
    					false
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(468:32) {#if showAreas.whatToMaintain}",
    		ctx
    	});
    ...
    // (459:12) {#each cat.assignments as assig}
    function create_each_block_1(ctx) {
    	let show_if = /*assig*/ ctx[51].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    	let if_block_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories, courseSettings*/ 10) show_if = /*assig*/ ctx[51].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(459:12) {#each cat.assignments as assig}",
    		ctx
    	});
    ...
    // (445:0) {#each categories as cat}
    function create_each_block(ctx) {
    	let details;
    	let summary;
    	let t0_value = /*cat*/ ctx[48].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[48].name], /*courseSettings*/ ctx[1].termEnabled) + "";
    	let t0;
    	let t1;
    	let ul2;
    	let nav;
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[42].call(input, /*each_value*/ ctx[49], /*cat_index*/ ctx[50]);
    	}

    	let each_value_1 = /*cat*/ ctx[48].assignments;
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			add_location(summary, file$1, 446, 8, 15432);
    			add_location(li0, file$1, 449, 20, 15606);
    			add_location(ul0, file$1, 449, 16, 15602);
    			attr_dev(input, "type", "number");
    			add_location(input, file$1, 452, 24, 15720);
    			add_location(p, file$1, 453, 24, 15792);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 451, 20, 15676);
    			add_location(li1, file$1, 450, 20, 15650);
    			add_location(ul1, file$1, 450, 16, 15646);
    			add_location(nav, file$1, 448, 12, 15579);
    			add_location(br, file$1, 457, 12, 15890);
    			attr_dev(ul2, "class", "longlist");
    			add_location(ul2, file$1, 447, 8, 15544);
    			add_location(details, file$1, 445, 4, 15413);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*cat*/ ctx[48].weight);
    			append_dev(div, t4);
    			append_dev(div, p);
    			append_dev(ul2, t6);
    			append_dev(ul2, br);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories, courseSettings*/ 10 && t0_value !== (t0_value = /*cat*/ ctx[48].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[48].name], /*courseSettings*/ ctx[1].termEnabled) + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*categories*/ 8 && to_number(input.value) !== /*cat*/ ctx[48].weight) {
    				set_input_value(input, /*cat*/ ctx[48].weight);
    			}

    			if (dirty[0] & /*categories, makeAssigVariable, showAreas, deleteAssignment, courseSettings*/ 1114250) {
    				each_value_1 = /*cat*/ ctx[48].assignments;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(445:0) {#each categories as cat}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let strong1;
    	let t5;
    	let t6_value = /*getCurrentGrade*/ ctx[14]() + "";
    	let t6;
    	let t7;
    	let strong2;
    	let t9;
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*issticky*/ ctx[10] && create_if_block_9(ctx);
    	let if_block1 = /*moreToolsOpen*/ ctx[12] && create_if_block_8(ctx);
    	let if_block2 = /*showAreas*/ ctx[7].equalWeighting && create_if_block_7(ctx);
    	let if_block3 = /*showAreas*/ ctx[7].gradingPeriods && create_if_block_6(ctx);
    	let if_block4 = /*showAreas*/ ctx[7].newAssig && create_if_block_5(ctx);
    	let if_block5 = /*showAreas*/ ctx[7].newCategory && create_if_block_4(ctx);
    	let if_block6 = /*showAreas*/ ctx[7].showGraph && create_if_block_3(ctx);
    	let if_block7 = /*showAreas*/ ctx[7].whatToMaintain && create_if_block_2$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h3, file$1, 268, 12, 8579);
    			add_location(li0, file$1, 268, 8, 8575);
    			add_location(ul0, file$1, 267, 4, 8561);
    			add_location(strong0, file$1, 271, 109, 8760);
    			attr_dev(a0, "role", "button");
    			attr_dev(a0, "class", "outline");
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file$1, 271, 12, 8663);
    			add_location(li1, file$1, 271, 8, 8659);
    			add_location(ul1, file$1, 270, 4, 8645);
    			add_location(nav, file$1, 266, 0, 8550);
    			add_location(strong1, file$1, 277, 7, 8883);
    			add_location(strong2, file$1, 277, 57, 8933);
    			add_location(p, file$1, 277, 4, 8880);
    			add_location(div0, file$1, 276, 0, 8850);
    			add_location(button0, file$1, 288, 4, 9235);
    			add_location(button1, file$1, 289, 4, 9314);
    			add_location(button2, file$1, 290, 4, 9394);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 287, 0, 9211);
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 293, 4, 9508);
    			attr_dev(small, "class", "sidewayslist");
    			add_location(small, file$1, 292, 0, 9474);
    			add_location(br0, file$1, 441, 0, 15326);
    			add_location(br1, file$1, 441, 4, 15330);
    			add_location(hr, file$1, 443, 0, 15376);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(a1, "click", /*click_handler_4*/ ctx[26], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (/*showAreas*/ ctx[7].equalWeighting) {
    				if (if_block2) {
    					if_block2.p(ctx, dirty);

    					if (dirty[0] & /*showAreas*/ 128) {
    			...
    			if (/*showAreas*/ ctx[7].gradingPeriods) {
    				if (if_block3) {
    			...
    			if (/*showAreas*/ ctx[7].newCategory) {
    				if (if_block5) {
    					...
    					if_block5.c();
    					transition_in(if_block5, 1);
    					if_block5.m(t26.parentNode, t26);
    				}
    			} else if (if_block5) {
    				group_outros();
    			...
    			if (/*showAreas*/ ctx[7].showGraph) {
    				if (if_block6) {
    					...
    					if_block6.c();
    					transition_in(if_block6, 1);
    					if_block6.m(t27.parentNode, t27);
    				}
    			} else if (if_block6) {
    				group_outros();
    			...
    			if (/*showAreas*/ ctx[7].whatToMaintain) {
    				if (if_block7) {
    					...
    					if_block7.c();
    					transition_in(if_block7, 1);
    					if_block7.m(t28.parentNode, t28);
    				}
    			} else if (if_block7) {
    				group_outros();
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	chrome.storage.local.get(key, result => {
    		if (result[key] != undefined) {
    			$$invalidate(1, courseSettings = result[key]);
    		}
    	});
    	...
    	function toggleArea(area) {
    		for (let a of Object.keys(showAreas)) {
    			if (a != area || showAreas[area] == true) $$invalidate(7, showAreas[a] = false, showAreas); else $$invalidate(7, showAreas[area] = true, showAreas);
    		}
    	}
    	...
    	function submitAssignment() {
    		for (let cat of categories) {
    			if (cat.name == newAssig["catName"]) {
    				...
    				$$invalidate(8, newAssig = new Assignment(10, 10, ""));
    				$$invalidate(3, categories);
    				return;
    			}
    		}
    	...
    	document.addEventListener('scroll', () => {
    		try {
    			if (window.pageYOffset > sticky.offsetTop) {
    				$$invalidate(10, issticky = true);
    			} else {
    				$$invalidate(10, issticky = false);
    			}
    		} catch(e) {
    	...
    	function makeAssigVariable(outOf, cat) {
    		$$invalidate(5, minNeedAssig.outof = outOf, minNeedAssig);
    		$$invalidate(5, minNeedAssig["catName"] = cat, minNeedAssig);
    	...
    	const click_handler_4 = () => {
    		$$invalidate(12, moreToolsOpen = !moreToolsOpen);
    	};
    	...
    	function input0_input_handler_2() {
    		...
    		$$invalidate(4, gradeWanted);
    	}

    	function select_change_handler_1() {
    		minNeedAssig["catName"] = select_value(this);
    		(((($$invalidate(5, minNeedAssig), $$invalidate(2, newGrade)), $$invalidate(3, categories)), $$invalidate(1, courseSettings)), $$invalidate(4, gradeWanted));
    		$$invalidate(3, categories);
    	}
    	...
    	function input_input_handler(each_value, cat_index) {
    		each_value[cat_index].weight = to_number(this.value);
    		$$invalidate(3, categories);
    	}

    	function input0_input_handler_3(each_value_1, assig_index) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('key' in $$props) $$invalidate(45, key = $$props.key);
    		if ('newGrade' in $$props) $$invalidate(2, newGrade = $$props.newGrade);
    		if ('categories' in $$props) $$invalidate(3, categories = $$props.categories);
    		if ('terms' in $$props) $$invalidate(6, terms = $$props.terms);
    		if ('tids' in $$props) tids = $$props.tids;
    		if ('showAreas' in $$props) $$invalidate(7, showAreas = $$props.showAreas);
    		if ('newAssig' in $$props) $$invalidate(8, newAssig = $$props.newAssig);
    		if ('newCategory' in $$props) $$invalidate(9, newCategory = $$props.newCategory);
    		if ('issticky' in $$props) $$invalidate(10, issticky = $$props.issticky);
    		if ('sticky' in $$props) $$invalidate(11, sticky = $$props.sticky);
    		if ('moreToolsOpen' in $$props) $$invalidate(12, moreToolsOpen = $$props.moreToolsOpen);
    		if ('gradesOverTime' in $$props) $$invalidate(19, gradesOverTime = $$props.gradesOverTime);
    		if ('gradeWanted' in $$props) $$invalidate(4, gradeWanted = $$props.gradeWanted);
    		if ('minNeedAssig' in $$props) $$invalidate(5, minNeedAssig = $$props.minNeedAssig);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*courseSettings*/ 2) {
    			{
    			...
    			// On change, update new grade with sum of weighted categories
    			{
    				...
    				if (courseSettings.allCategoriesWeightedSame) {
    					...
    					for (let cat of categories) {
    						...
    						if (!isNaN(x)) {
    							$$invalidate(2, newGrade += x);
    							catCount++;
    						}
    					}

    					$$invalidate(2, newGrade /= catCount);
    				}
    		...
    		if ($$self.$$.dirty[0] & /*newGrade, categories, minNeedAssig, courseSettings, gradeWanted*/ 62) {
    			{
    ...
    */
    				try {
    					...
    					$$invalidate(5, minNeedAssig.score = newScore, minNeedAssig);
    				} catch(e) {
    ...
    class Editor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { course: 0 }, null, [-1, -1, -1]);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file, 59, 6, 1516);
    			add_location(p0, file, 59, 3, 1513);
    			attr_dev(a, "href", /*icURL*/ ctx[1]);
    			add_location(a, file, 60, 14, 1574);
    			add_location(p1, file, 60, 3, 1563);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 57, 3, 1408);
    			add_location(br, file, 57, 61, 1466);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(57:2) {#if loadingState == \\\"loading\\\"}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 66, 3, 1770);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 64, 3, 1671);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(64:2) {#if currentPage == \\\"Home\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 55, 1, 1345);
    			add_location(small0, file, 73, 7, 1945);
    			add_location(li0, file, 73, 3, 1941);
    			add_location(ul0, file, 72, 2, 1932);
    			add_location(small1, file, 76, 78, 2093);
    			attr_dev(a0, "href", "https://benman604.github.io/Infinite-Campus-Grade-Predictor/");
    			add_location(a0, file, 76, 7, 2022);
    			add_location(li1, file, 76, 3, 2018);
    			add_location(small2, file, 77, 78, 2202);
    			attr_dev(a1, "href", "https://github.com/benman604/Infinite-Campus-Grade-Predictor");
    			add_location(a1, file, 77, 7, 2131);
    			add_location(li2, file, 77, 3, 2127);
    			add_location(ul1, file, 75, 2, 2009);
    			add_location(nav, file, 71, 1, 1923);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file, 51, 0, 1289);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
