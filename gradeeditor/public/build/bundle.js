...
var app = (function () {
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = text(t6_value);
    			t7 = text("%");
    			add_location(strong0, file$1, 243, 11, 7790);
    			add_location(strong1, file$1, 243, 61, 7840);
    			add_location(p, file$1, 243, 8, 7787);
    			attr_dev(div, "class", "sticky");
    			add_location(div, file$1, 242, 4, 7757);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "#a");
    			add_location(a0, file$1, 256, 8, 8364);
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 257, 8, 8452);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(a0, "click", /*click_handler_4*/ ctx[23], false, false, false),
    					listen_dev(a1, "click", /*click_handler_5*/ ctx[24], false, false, false)
    				];
    ...
    // (263:0) {#if showAreas.equalWeighting}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(h4, file$1, 265, 12, 8696);
    			add_location(p, file$1, 266, 12, 8734);
    			add_location(hr, file$1, 281, 12, 9377);
    			add_location(br, file$1, 281, 16, 9381);
    			add_location(li0, file$1, 283, 20, 9446);
    			add_location(ul0, file$1, 283, 16, 9442);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "category");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 286, 24, 9584);
    			attr_dev(label, "for", "category");
    			add_location(label, file$1, 285, 20, 9536);
    			add_location(li1, file$1, 284, 20, 9510);
    			add_location(ul1, file$1, 284, 16, 9506);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 282, 12, 9399);
    			add_location(div, file$1, 264, 8, 8677);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 263, 4, 8625);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "change", /*input_change_handler_1*/ ctx[26]);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(263:0) {#if showAreas.equalWeighting}",
    		ctx
    	});
    ...
    // (268:12) {#each categories as cat}
    function create_each_block_4(ctx) {
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*cat*/ ctx[41].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input_change_handler() {
    		/*input_change_handler*/ ctx[25].call(input, /*cat*/ ctx[41]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			add_location(li0, file$1, 270, 24, 8947);
    			add_location(ul0, file$1, 269, 20, 8917);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 274, 28, 9099);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 273, 28, 9049);
    			add_location(li1, file$1, 273, 24, 9045);
    			add_location(ul1, file$1, 272, 20, 9015);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 268, 16, 8871);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[41].name];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*cat*/ ctx[41].name + "")) set_data_dev(t0, t0_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(268:12) {#each categories as cat}",
    		ctx
    	});
    ...
    // (296:0) {#if showAreas.gradingPeriods}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$1, 298, 12, 9947);
    			add_location(p, file$1, 299, 12, 9985);
    			add_location(div, file$1, 297, 8, 9928);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 296, 4, 9876);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, div);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(296:0) {#if showAreas.gradingPeriods}",
    		ctx
    	});
    ...
    // (301:12) {#each Object.keys(terms) as term}
    function create_each_block_3(ctx) {
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*terms*/ ctx[4][/*term*/ ctx[49]].name + "";
    	let t0;
    	let t1;
    	let ul1;
    	let li1;
    	...
    	function input_change_handler_2() {
    		/*input_change_handler_2*/ ctx[27].call(input, /*term*/ ctx[49]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			t2 = space();
    			add_location(li0, file$1, 303, 24, 10220);
    			add_location(ul0, file$1, 302, 20, 10190);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "name", "switch");
    			attr_dev(input, "id", "switch");
    			attr_dev(input, "role", "switch");
    			add_location(input, file$1, 307, 28, 10380);
    			attr_dev(label, "for", "switch");
    			add_location(label, file$1, 306, 28, 10330);
    			add_location(li1, file$1, 306, 24, 10326);
    			add_location(ul1, file$1, 305, 20, 10296);
    			set_style(nav, "width", "100%");
    			add_location(nav, file$1, 301, 16, 10144);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, nav, anchor);
    			append_dev(nav, ul0);
    			...
    			append_dev(li1, label);
    			append_dev(label, input);
    			input.checked = /*courseSettings*/ ctx[1].termEnabled[/*term*/ ctx[49].toString()];
    			append_dev(nav, t2);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*terms*/ 16 && t0_value !== (t0_value = /*terms*/ ctx[4][/*term*/ ctx[49]].name + "")) set_data_dev(t0, t0_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(301:12) {#each Object.keys(terms) as term}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 323, 20, 10968);
    			attr_dev(label0, "for", "aName");
    			add_location(label0, file$1, 322, 16, 10912);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*newAssig*/ ctx[6]["catName"] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[29].call(select));
    			add_location(select, file$1, 327, 20, 11121);
    			attr_dev(label1, "for", "aCat");
    			add_location(label1, file$1, 326, 16, 11073);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 321, 12, 10876);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aScore");
    			input1.required = true;
    			add_location(input1, file$1, 337, 20, 11517);
    			attr_dev(label2, "for", "aScore");
    			add_location(label2, file$1, 336, 16, 11470);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "name", "aOutOf");
    			input2.required = true;
    			add_location(input2, file$1, 340, 20, 11681);
    			attr_dev(label3, "for", "aOutOf");
    			add_location(label3, file$1, 339, 16, 11633);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 335, 12, 11434);
    			attr_dev(input3, "type", "submit");
    			input3.value = "Add";
    			add_location(input3, file$1, 344, 12, 11815);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 320, 8, 10801);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 319, 4, 10749);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(319:0) {#if showAreas.newAssig}",
    		ctx
    	});
    ...
    // (329:24) {#each categories as cat}
    function create_each_block_2(ctx) {
    	let option;
    	let t_value = /*cat*/ ctx[41].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*cat*/ ctx[41].name;
    			option.value = option.__value;
    			add_location(option, file$1, 329, 28, 11264);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories*/ 8 && t_value !== (t_value = /*cat*/ ctx[41].name + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*categories*/ 8 && option_value_value !== (option_value_value = /*cat*/ ctx[41].name)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(329:24) {#each categories as cat}",
    		ctx
    	});
    ...
    // (351:0) {#if showAreas.newCategory}
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 355, 20, 12168);
    			attr_dev(label0, "for", "cName");
    			add_location(label0, file$1, 354, 16, 12114);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "100");
    			attr_dev(input1, "name", "cWeight");
    			input1.required = true;
    			add_location(input1, file$1, 358, 20, 12336);
    			attr_dev(label1, "for", "cWeight");
    			add_location(label1, file$1, 357, 16, 12283);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 353, 12, 12078);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add";
    			add_location(input2, file$1, 361, 12, 12491);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 352, 8, 12005);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 351, 4, 11953);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, form);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*input0_input_handler_1*/ ctx[32]),
    					listen_dev(input1, "input", /*input1_input_handler_1*/ ctx[33]),
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(351:0) {#if showAreas.newCategory}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 368, 4, 12615);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(368:0) {#if showAreas.showGraph}",
    		ctx
    	});
    ...
    // (393:16) {#if assig.isEnabled(courseSettings.termEnabled)}
    function create_if_block$1(ctx) {
    	let li2;
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*assig*/ ctx[44].name + "";
    	let t0;
    	let t1;
    	let t2_value = /*assig*/ ctx[44].toString() + "";
    	let t2;
    	let t3;
    	let t4_value = /*assig*/ ctx[44].getOgGrade() + "";
    	let t4;
    	let t5;
    	let a;
    	let t7;
    	...
    	function input0_input_handler_2() {
    		/*input0_input_handler_2*/ ctx[35].call(input0, /*each_value_1*/ ctx[45], /*assig_index*/ ctx[46]);
    	}

    	function input1_input_handler_2() {
    		/*input1_input_handler_2*/ ctx[36].call(input1, /*each_value_1*/ ctx[45], /*assig_index*/ ctx[46]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			attr_dev(a, "href", "/");
    			add_location(a, file$1, 397, 28, 13679);
    			add_location(li0, file$1, 394, 28, 13532);
    			add_location(ul0, file$1, 394, 24, 13528);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 401, 32, 13908);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out Of");
    			add_location(input1, file$1, 402, 32, 14008);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 400, 28, 13856);
    			add_location(li1, file$1, 399, 28, 13822);
    			add_location(ul1, file$1, 399, 24, 13818);
    			add_location(nav, file$1, 393, 24, 13497);
    			add_location(li2, file$1, 393, 20, 13493);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*assig*/ ctx[44].score);
    			append_dev(div, t8);
    			append_dev(div, input1);
    			set_input_value(input1, /*assig*/ ctx[44].outof);
    			append_dev(nav, t9);
    				...
    				dispose = [
    					listen_dev(
    						...
    						prevent_default(function () {
    							if (is_function(/*deleteAssignment*/ ctx[14](/*cat*/ ctx[41], /*assig*/ ctx[44]))) /*deleteAssignment*/ ctx[14](/*cat*/ ctx[41], /*assig*/ ctx[44]).apply(this, arguments);
    						}),
    						false,
    						true,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 8 && t0_value !== (t0_value = /*assig*/ ctx[44].name + "")) set_data_dev(t0, t0_value);
    			if (dirty[0] & /*categories*/ 8 && t2_value !== (t2_value = /*assig*/ ctx[44].toString() + "")) set_data_dev(t2, t2_value);
    			if (dirty[0] & /*categories*/ 8 && t4_value !== (t4_value = /*assig*/ ctx[44].getOgGrade() + "")) set_data_dev(t4, t4_value);

    			if (dirty[0] & /*categories*/ 8 && to_number(input0.value) !== /*assig*/ ctx[44].score) {
    				set_input_value(input0, /*assig*/ ctx[44].score);
    			}

    			if (dirty[0] & /*categories*/ 8 && to_number(input1.value) !== /*assig*/ ctx[44].outof) {
    				set_input_value(input1, /*assig*/ ctx[44].outof);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(393:16) {#if assig.isEnabled(courseSettings.termEnabled)}",
    		ctx
    	});
    ...
    // (391:12) {#each cat.assignments as assig}
    function create_each_block_1(ctx) {
    	let show_if = /*assig*/ ctx[44].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    	let if_block_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories, courseSettings*/ 10) show_if = /*assig*/ ctx[44].isEnabled(/*courseSettings*/ ctx[1].termEnabled);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(391:12) {#each cat.assignments as assig}",
    		ctx
    	});
    ...
    // (377:0) {#each categories as cat}
    function create_each_block(ctx) {
    	let details;
    	let summary;
    	let t0_value = /*cat*/ ctx[41].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[41].name], /*courseSettings*/ ctx[1].termEnabled) + "";
    	let t0;
    	let t1;
    	let ul2;
    	let nav;
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[34].call(input, /*each_value*/ ctx[42], /*cat_index*/ ctx[43]);
    	}

    	let each_value_1 = /*cat*/ ctx[41].assignments;
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			add_location(summary, file$1, 378, 8, 12843);
    			add_location(li0, file$1, 381, 20, 13017);
    			add_location(ul0, file$1, 381, 16, 13013);
    			attr_dev(input, "type", "number");
    			add_location(input, file$1, 384, 24, 13131);
    			add_location(p, file$1, 385, 24, 13203);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 383, 20, 13087);
    			add_location(li1, file$1, 382, 20, 13061);
    			add_location(ul1, file$1, 382, 16, 13057);
    			add_location(nav, file$1, 380, 12, 12990);
    			add_location(br, file$1, 389, 12, 13301);
    			attr_dev(ul2, "class", "longlist");
    			add_location(ul2, file$1, 379, 8, 12955);
    			add_location(details, file$1, 377, 4, 12824);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*cat*/ ctx[41].weight);
    			append_dev(div, t4);
    			append_dev(div, p);
    			append_dev(ul2, t6);
    			append_dev(ul2, br);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories, courseSettings*/ 10 && t0_value !== (t0_value = /*cat*/ ctx[41].toString(/*courseSettings*/ ctx[1].equalWeighting[/*cat*/ ctx[41].name], /*courseSettings*/ ctx[1].termEnabled) + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*categories*/ 8 && to_number(input.value) !== /*cat*/ ctx[41].weight) {
    				set_input_value(input, /*cat*/ ctx[41].weight);
    			}

    			if (dirty[0] & /*categories, deleteAssignment, courseSettings*/ 16394) {
    				each_value_1 = /*cat*/ ctx[41].assignments;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(377:0) {#each categories as cat}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h3, file$1, 229, 12, 7316);
    			add_location(li0, file$1, 229, 8, 7312);
    			add_location(ul0, file$1, 228, 4, 7298);
    			add_location(strong0, file$1, 232, 109, 7497);
    			attr_dev(a0, "role", "button");
    			attr_dev(a0, "class", "outline");
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file$1, 232, 12, 7400);
    			add_location(li1, file$1, 232, 8, 7396);
    			add_location(ul1, file$1, 231, 4, 7382);
    			add_location(nav, file$1, 227, 0, 7287);
    			add_location(strong1, file$1, 238, 7, 7620);
    			add_location(strong2, file$1, 238, 57, 7670);
    			add_location(p, file$1, 238, 4, 7617);
    			add_location(div0, file$1, 237, 0, 7587);
    			add_location(button0, file$1, 249, 4, 7972);
    			add_location(button1, file$1, 250, 4, 8051);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 248, 0, 7948);
    			attr_dev(a1, "href", "#a");
    			add_location(a1, file$1, 254, 4, 8254);
    			attr_dev(small, "class", "sidewayslist");
    			add_location(small, file$1, 253, 0, 8220);
    			add_location(br0, file$1, 373, 0, 12737);
    			add_location(br1, file$1, 373, 4, 12741);
    			add_location(hr, file$1, 375, 0, 12787);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(a1, "click", /*click_handler_3*/ ctx[22], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	for (let term of course.terms) {
    		...
    		if (course.terms.length == 4) {
    			...
    			if (d2 && newTerm.seq == 2 || d4 && newTerm.seq == 4) courseSettings.termEnabled[term.termID] = true;
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('key' in $$props) $$invalidate(39, key = $$props.key);
    		...
    		if ('gradesOverTime' in $$props) $$invalidate(17, gradesOverTime = $$props.gradesOverTime);
    	};
