    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			add_location(strong, file$2, 23, 15, 550);
    			add_location(p, file$2, 23, 12, 547);
    			add_location(li0, file$2, 22, 12, 529);
    			add_location(ul0, file$2, 22, 8, 525);
    			add_location(button, file$2, 27, 12, 699);
    			add_location(li1, file$2, 26, 12, 681);
    			add_location(ul1, file$2, 26, 8, 677);
    			add_location(nav, file$2, 21, 4, 510);
    		},
    ...
    class Home extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*classes*/ ctx[0] === undefined && !('classes' in props)) {
    			console_1.warn("<Home> was created without expected prop 'classes'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 8, 12, 173);
    			add_location(li0, file$1, 8, 8, 169);
    			add_location(ul0, file$1, 7, 4, 155);
    			add_location(button, file$1, 11, 12, 257);
    			add_location(li1, file$1, 11, 8, 253);
    			add_location(ul1, file$1, 10, 4, 239);
    			add_location(nav, file$1, 6, 0, 144);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
