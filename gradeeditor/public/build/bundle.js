...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 27, 4, 752);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(27:0) {#if classes.length == 0}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block = /*classes*/ ctx[0].length == 0 && create_if_block$2(ctx);
    ...
    function create_if_block_3(ctx) {
    	...
    	let strong0;
    	let t1;
    	let t2_value = /*getCurrentGrade*/ ctx[9]() + "";
    	let t2;
    	let t3;
    	let strong1;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = text(t6_value);
    			t7 = text("%");
    			add_location(strong0, file$1, 169, 11, 5327);
    			add_location(strong1, file$1, 169, 62, 5378);
    			add_location(p, file$1, 169, 8, 5324);
    			attr_dev(div, "class", "sticky");
    			add_location(div, file$1, 168, 4, 5294);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 186, 20, 6039);
    			attr_dev(label0, "for", "aName");
    			add_location(label0, file$1, 185, 16, 5983);
    			attr_dev(select, "name", "aCat");
    			select.required = true;
    			if (/*newAssig*/ ctx[4]["catName"] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[19].call(select));
    			add_location(select, file$1, 190, 20, 6192);
    			attr_dev(label1, "for", "aCat");
    			add_location(label1, file$1, 189, 16, 6144);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file$1, 184, 12, 5947);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "aScore");
    			input1.required = true;
    			add_location(input1, file$1, 200, 20, 6588);
    			attr_dev(label2, "for", "aScore");
    			add_location(label2, file$1, 199, 16, 6541);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "name", "aOutOf");
    			input2.required = true;
    			add_location(input2, file$1, 203, 20, 6752);
    			attr_dev(label3, "for", "aOutOf");
    			add_location(label3, file$1, 202, 16, 6704);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 198, 12, 6505);
    			attr_dev(input3, "type", "submit");
    			input3.value = "Add";
    			add_location(input3, file$1, 207, 12, 6886);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 183, 8, 5872);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 182, 4, 5820);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*submitAssignment*/ ctx[12]), false, true, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(182:0) {#if showAreas.newAssig}",
    		ctx
    	});
    ...
    // (192:24) {#each categories as cat}
    function create_each_block_2(ctx) {
    	let option;
    	let t_value = /*cat*/ ctx[27].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*cat*/ ctx[27].name;
    			option.value = option.__value;
    			add_location(option, file$1, 192, 28, 6335);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories*/ 4 && t_value !== (t_value = /*cat*/ ctx[27].name + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*categories*/ 4 && option_value_value !== (option_value_value = /*cat*/ ctx[27].name)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(192:24) {#each categories as cat}",
    		ctx
    	});
    ...
    // (214:0) {#if showAreas.newCategory}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 218, 20, 7239);
    			attr_dev(label0, "for", "cName");
    			add_location(label0, file$1, 217, 16, 7185);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "100");
    			attr_dev(input1, "name", "cWeight");
    			input1.required = true;
    			add_location(input1, file$1, 221, 20, 7407);
    			attr_dev(label1, "for", "cWeight");
    			add_location(label1, file$1, 220, 16, 7354);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 216, 12, 7149);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add";
    			add_location(input2, file$1, 224, 12, 7562);
    			attr_dev(form, "action", "#");
    			add_location(form, file$1, 215, 8, 7076);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 214, 4, 7024);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, form);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*submitCategory*/ ctx[13]), false, true, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(214:0) {#if showAreas.newCategory}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 232, 8, 7738);
    			attr_dev(article, "class", "subcard");
    			add_location(article, file$1, 231, 4, 7686);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(231:0) {#if showAreas.showGraph}",
    		ctx
    	});
    ...
    // (243:12) {#each cat.assignments as assig}
    function create_each_block_1(ctx) {
    	let li2;
    	let nav;
    	let ul0;
    	let li0;
    	let t0_value = /*assig*/ ctx[30].name + "";
    	let t0;
    	let t1;
    	let t2_value = /*assig*/ ctx[30].toString() + "";
    	let t2;
    	let t3;
    	let t4_value = /*assig*/ ctx[30].getOgGrade() + "";
    	let t4;
    	let t5;
    	let a;
    	let t7;
    	...
    	function input0_input_handler_2() {
    		/*input0_input_handler_2*/ ctx[24].call(input0, /*each_value_1*/ ctx[31], /*assig_index*/ ctx[32]);
    	}

    	function input1_input_handler_2() {
    		/*input1_input_handler_2*/ ctx[25].call(input1, /*each_value_1*/ ctx[31], /*assig_index*/ ctx[32]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			attr_dev(a, "href", "/");
    			add_location(a, file$1, 248, 24, 8231);
    			add_location(li0, file$1, 245, 24, 8096);
    			add_location(ul0, file$1, 245, 20, 8092);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "Score");
    			add_location(input0, file$1, 252, 28, 8444);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Out Of");
    			add_location(input1, file$1, 253, 28, 8540);
    			attr_dev(div, "class", "grid");
    			add_location(div, file$1, 251, 24, 8396);
    			add_location(li1, file$1, 250, 24, 8366);
    			add_location(ul1, file$1, 250, 20, 8362);
    			add_location(nav, file$1, 244, 20, 8065);
    			add_location(li2, file$1, 244, 16, 8061);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*assig*/ ctx[30].score);
    			append_dev(div, t8);
    			append_dev(div, input1);
    			set_input_value(input1, /*assig*/ ctx[30].outof);
    			append_dev(nav, t9);
    				...
    				dispose = [
    					listen_dev(
    						...
    						prevent_default(function () {
    							if (is_function(/*deleteAssignment*/ ctx[11](/*cat*/ ctx[27], /*assig*/ ctx[30]))) /*deleteAssignment*/ ctx[11](/*cat*/ ctx[27], /*assig*/ ctx[30]).apply(this, arguments);
    						}),
    						false,
    						true,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*categories*/ 4 && t0_value !== (t0_value = /*assig*/ ctx[30].name + "")) set_data_dev(t0, t0_value);
    			if (dirty[0] & /*categories*/ 4 && t2_value !== (t2_value = /*assig*/ ctx[30].toString() + "")) set_data_dev(t2, t2_value);
    			if (dirty[0] & /*categories*/ 4 && t4_value !== (t4_value = /*assig*/ ctx[30].getOgGrade() + "")) set_data_dev(t4, t4_value);

    			if (dirty[0] & /*categories*/ 4 && to_number(input0.value) !== /*assig*/ ctx[30].score) {
    				set_input_value(input0, /*assig*/ ctx[30].score);
    			}

    			if (dirty[0] & /*categories*/ 4 && to_number(input1.value) !== /*assig*/ ctx[30].outof) {
    				set_input_value(input1, /*assig*/ ctx[30].outof);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(243:12) {#each cat.assignments as assig}",
    		ctx
    	});
    ...
    // (239:0) {#each categories as cat}
    function create_each_block(ctx) {
    	let details;
    	let summary;
    	let t0_value = /*cat*/ ctx[27].toString() + "";
    	let t0;
    	let t1;
    	let ul;
    	let t2;
    	let each_value_1 = /*cat*/ ctx[27].assignments;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			add_location(summary, file$1, 240, 8, 7878);
    			attr_dev(ul, "class", "longlist");
    			add_location(ul, file$1, 241, 8, 7923);
    			add_location(details, file$1, 239, 4, 7859);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*categories*/ 4 && t0_value !== (t0_value = /*cat*/ ctx[27].toString() + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*categories, deleteAssignment*/ 2052) {
    				each_value_1 = /*cat*/ ctx[27].assignments;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(239:0) {#each categories as cat}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let strong1;
    	let t5;
    	let t6_value = /*getCurrentGrade*/ ctx[9]() + "";
    	let t6;
    	let t7;
    	let strong2;
    	let t9;
    	...
    	let if_block2 = /*showAreas*/ ctx[3].newCategory && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h3, file$1, 155, 12, 4882);
    			add_location(li0, file$1, 155, 8, 4878);
    			add_location(ul0, file$1, 154, 4, 4864);
    			add_location(strong0, file$1, 158, 79, 5033);
    			attr_dev(a, "href", "#/");
    			add_location(a, file$1, 158, 12, 4966);
    			add_location(li1, file$1, 158, 8, 4962);
    			add_location(ul1, file$1, 157, 4, 4948);
    			add_location(nav, file$1, 153, 0, 4853);
    			add_location(strong1, file$1, 164, 7, 5156);
    			add_location(strong2, file$1, 164, 58, 5207);
    			add_location(p, file$1, 164, 4, 5153);
    			add_location(div0, file$1, 163, 0, 5123);
    			add_location(button0, file$1, 175, 4, 5510);
    			add_location(button1, file$1, 176, 4, 5589);
    			attr_dev(div1, "class", "grid");
    			add_location(div1, file$1, 174, 0, 5486);
    			add_location(hr, file$1, 237, 0, 7822);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 42, 3, 1179);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 40, 3, 1080);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(40:2) {#if currentPage == \\\"Home\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file, 36, 1, 1026);
    			add_location(article, file, 38, 1, 1035);
    			add_location(small0, file, 48, 7, 1336);
    			add_location(li0, file, 48, 3, 1332);
    			add_location(ul0, file, 47, 2, 1323);
    			add_location(small1, file, 51, 20, 1426);
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file, 51, 7, 1413);
    			add_location(li1, file, 51, 3, 1409);
    			add_location(small2, file, 52, 20, 1477);
    			attr_dev(a1, "href", "#/");
    			add_location(a1, file, 52, 7, 1464);
    			add_location(li2, file, 52, 3, 1460);
    			add_location(small3, file, 53, 20, 1527);
    			attr_dev(a2, "href", "#/");
    			add_location(a2, file, 53, 7, 1514);
    			add_location(li3, file, 53, 3, 1510);
    			add_location(ul1, file, 50, 2, 1400);
    			add_location(nav, file, 46, 1, 1314);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 35, 0, 1000);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	chrome.storage.local.get(['IC_subdomain'], res => {
    		chrome.tabs.create({
    			url: `https://${res.IC_subdomain}.infinitecampus.org/campus/resources/portal/grades?q=${Date.now()}`
    		});
    	});
