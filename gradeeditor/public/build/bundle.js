    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 39, 3, 990);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 37, 3, 891);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:2) {#if currentPage == \\\"Home\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file, 33, 1, 837);
    			add_location(article, file, 35, 1, 846);
    			add_location(small0, file, 45, 7, 1147);
    			add_location(li0, file, 45, 3, 1143);
    			add_location(ul0, file, 44, 2, 1134);
    			add_location(small1, file, 48, 20, 1237);
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file, 48, 7, 1224);
    			add_location(li1, file, 48, 3, 1220);
    			add_location(small2, file, 49, 20, 1288);
    			attr_dev(a1, "href", "#/");
    			add_location(a1, file, 49, 7, 1275);
    			add_location(li2, file, 49, 3, 1271);
    			add_location(small3, file, 50, 20, 1338);
    			attr_dev(a2, "href", "#/");
    			add_location(a2, file, 50, 7, 1325);
    			add_location(li3, file, 50, 3, 1321);
    			add_location(ul1, file, 47, 2, 1211);
    			add_location(nav, file, 43, 1, 1125);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 32, 0, 811);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
